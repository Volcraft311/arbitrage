...
function PANEL:Init()
    ...
    self.main.Paint = function(panel, w, h)
        ...
        draw.DrawText(L("#monomenu_screen_start"), "arb.Font_FuturaPTBook_5", W(10), H(3), color_white, TEXT_ALIGN_LEFT)

        draw.DrawText(L("#monomenu_screen_setname"), "arb.Font_FuturaPTBook_7", W(10), H(28), color_white, TEXT_ALIGN_LEFT)
        draw.DrawText(L("#monomenu_screen_nameexample"), "arb.Font_FuturaPTBook_7", W(10), H(50), Color(150, 150, 150, 255), TEXT_ALIGN_LEFT)

        draw.DrawText(L("#monomenu_screen_chapternumber"), "arb.Font_FuturaPTBook_7", W(10), H(80 + 28), color_white, TEXT_ALIGN_LEFT)
        draw.DrawText(L("#monomenu_screen_chapterexample"), "arb.Font_FuturaPTBook_7", W(10), H(80 + 50), Color(150, 150, 150, 255), TEXT_ALIGN_LEFT)

        draw.DrawText(L("#monomenu_screen_settext"), "arb.Font_FuturaPTBook_7", W(10), H(80 + 80 + 28), color_white, TEXT_ALIGN_LEFT)
        draw.DrawText(L("#monomenu_screen_textexample"), "arb.Font_FuturaPTBook_7", W(10), H(80 + 80 + 50), Color(150, 150, 150, 255), TEXT_ALIGN_LEFT)
    end
    ...
    self.nameEntry:SetPlaceholderText(L("#monomenu_screen_example"))
