...
-- luacheck: ignore
Arbitrage.markup = Arbitrage.markup or {}
...
function MarkupObject:draw(xOffset, yOffset, halign, valign, alphaoverride)
	for i = 1, #self.blocks do
		...
		if (blk.texture) then
			...
			local r = blk.r or 255
			local g = blk.g or 255
			local b = blk.b or 255

			surface.SetDrawColor(r, g, b, alphaoverride or blk.colour.a or 255)
...
function Arbitrage.markup.Parse(ml, maxwidth)
