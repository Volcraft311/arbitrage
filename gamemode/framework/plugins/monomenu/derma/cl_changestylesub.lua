...
function PANEL:Init()
    ...
    self.main.Paint = function(panel, w, h)
        ...
        draw.DrawText(L("#monomenu_splash_entername"), "arb.Font_FuturaPTBook_7", W(10), H(28), color_white, TEXT_ALIGN_LEFT)
        draw.DrawText(L("#monomenu_splash_example"), "arb.Font_FuturaPTBook_7", W(10), H(50), Color(150, 150, 150, 255), TEXT_ALIGN_LEFT)

        draw.DrawText(L("#monomenu_splash_color"), "arb.Font_FuturaPTBook_7", W(10), H(80 + 28), color_white, TEXT_ALIGN_LEFT)
    end
    ...
    self.title:SetValue(L("#monomenu_splash_freetime"))
    self.title:SetPos(W(5), H(75))
    self.title:SetSize(self.main:GetWide() - W(10), H(25))
    self.title:SetPlaceholderText(L("#monomenu_splash_freetime"))
