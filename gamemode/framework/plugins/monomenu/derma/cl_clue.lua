...
function PANEL:InitClue()
    ...
    self.createButton:SetTall(H(25))
    ...
    self.createButton.Paint = function(_, w, h)
        ...
        draw.DrawText("Создать улику в мире", "arb.Font_FuturaPTBook_8", w / 2, H(0), Color(255, 220, 228, _.alpha), TEXT_ALIGN_CENTER)
    ...
    self.addButton.Paint = function(_, w, h)
        _.alpha = Lerp(FrameTime() * 10, _.alpha, _:IsHovered() and 255 or 30)
        draw.DrawText("Зарегистрировать новую улику на сервере", "arb.Font_FuturaPTBook_8", w / 2, H(0), Color(255, 220, 228, _.alpha), TEXT_ALIGN_CENTER)
    ...
    self.cluePanel:DockMargin(W(5), H(5), W(5), H(5))
...
function PANEL:Init()
    ...
    self.descEntry:SetSize(self.main:GetWide() - W(10), H(120))
    ...
    self.inPanel:SetPos(W(10), H(390))
    self.inPanel:SetSize(self.main:GetWide() - W(10), H(120))
...
function PANEL:Init()
    ...
    self.cluePanel:Dock(FILL)
    self.cluePanel:DockMargin(W(5), H(55), W(5), H(5))
    ...
    for k, v in pairs(Arbitrage.evidence.data, {}) do
        ...
        panel.Paint = function(_, w, h)
            ...
            draw.DrawText(k, "arb.Font_FuturaPTBook_6", w - 10, H(2), Color(255, 220, 228, 255 * 0.2), TEXT_ALIGN_RIGHT)
        end
