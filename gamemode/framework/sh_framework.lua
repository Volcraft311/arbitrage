...
do
    ...
    -- Ближнее
    Arbitrage.weapon.Add("tfa_nmrih_bat", "big", true)
    Arbitrage.weapon.Add("tfa_nmrih_sledge", "big", true)
    Arbitrage.weapon.Add("tfa_nmrih_kknife", "small", false)
    Arbitrage.weapon.Add("tfa_nmrih_machete", "big", false)
    Arbitrage.weapon.Add("tfa_nmrih_bcd", "small", false)
    Arbitrage.weapon.Add("tfa_nmrih_crowbar", "big", false)
    Arbitrage.weapon.Add("tfa_nmrih_fireaxe", "big", false)
    Arbitrage.weapon.Add("tfa_nmrih_lpipe", "big", true)
    Arbitrage.weapon.Add("tfa_nmrih_cleaver", "small", false)
    Arbitrage.weapon.Add("tfa_nmrih_hatchet", "big", false)
    Arbitrage.weapon.Add("tfa_nmrih_wrench", "small", false)
    Arbitrage.weapon.Add("tfa_nmrih_big", "blunt", false)
    Arbitrage.weapon.Add("tfa_nmrih_etool", "big", false)
    Arbitrage.weapon.Add("tfa_nmrih_asaw", "big", false)
    Arbitrage.weapon.Add("tfa_nmrih_chainsaw", "big", false)
    Arbitrage.weapon.Add("tfa_nmrih_fubar", "big", false)
    Arbitrage.weapon.Add("tfa_nmrih_pickaxe", "big", false)
    Arbitrage.weapon.Add("tfa_nmrih_sledge", "big", false)
    Arbitrage.weapon.Add("tfa_nmrih_spade", "big", false)
