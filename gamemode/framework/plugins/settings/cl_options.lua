SETTINGS.options.Add("interface_open_button", SETTINGS.type.bool, true, {
    name = "Отображение кнопки открытия интерфейса",
    title = "Кнопка открытия интерфейса",
    description = "Отображает подсказку в нижнем левом углу экрана, на котором отображена кнопка, при нажатии которой будет открыт интерфейс с информацией о персонаже. При отключении, кнопка отвечающая за открытие интерфейса будет всё также функционировать.",
...
SETTINGS.options.Add("camera_smoothness", SETTINGS.type.number, 35, {
