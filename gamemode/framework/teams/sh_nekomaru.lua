...
TEAM.name = "Нэкомару Нидай"
TEAM.description = "Абсолютный Тренер"
TEAM.category = "GOODBYE DESPAIR"
TEAM.model = "models/player/yourtoast4/danganronpa/akane_owari.mdl"
TEAM.path = "danganronpa/characters/nekomaru"
TEAM.uniqueID = "nekomaru"

TEAM.color = Color(240, 201, 73)
TEAM.evidenceVisibility = 0.3
TEAM.staminaSpeed = 1.4
TEAM.walkSpeed = 1
TEAM.runSpeed = 1
TEAM.hungerSpeed = 33
TEAM.thirstSpeed = 36
...
TEAM_NEKOMARU = Arbitrage.teams.Create(TEAM)