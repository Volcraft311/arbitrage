...
function PANEL:InitColorModify()
    ...
    enableButton:SetText(L("#colorcorrection_turnon"))
    ...
    returnButton.Paint = function(_, w, h)
        ...
        draw.DrawText(L("#colorcorrection_restore"), "arb.Font_FuturaPTBook_8", w / 2, H(0), Color(255, 220, 228, _.alpha), TEXT_ALIGN_CENTER)
    ...
    saveButton.Paint = function(_, w, h)
        _.alpha = Lerp(FrameTime() * 10, _.alpha, _:IsHovered() and 255 or 30)
        draw.DrawText(L("#colorcorrection_configs"), "arb.Font_FuturaPTBook_8", w / 2, H(0), Color(255, 220, 228, _.alpha), TEXT_ALIGN_CENTER)
    ...
    saveButton.DoClick = function()
        ...
        Menu:AddOption(L("#colorcorrection_savecc"), function()
    ...
    enablePlayersButton:SetText(L("#colorcorrection_turnply"))
...
function PANEL:Paint(w, h)
    ...
    draw.DrawText(L("#colorcorrection_title"), "arb.Font_FuturaPTDemi_8", W(10), H(3), color_white, TEXT_ALIGN_LEFT)

    draw.DrawText(L("#colorcorrection_name"), "arb.Font_FuturaPTBook_7", W(30), H(45), color_white, TEXT_ALIGN_LEFT)
    draw.DrawText(L("#colorcorrection_desc"), "arb.Font_FuturaPTBook_7", W(550), H(45), color_white, TEXT_ALIGN_LEFT)
end
