...
TEAM.name = "Саяка Майзоно"
TEAM.description = "Абсолютная Поп-Звезда"
TEAM.category = "TRIGGER HAPPY HAVOC"
TEAM.model = "models/player/dewobedil/sayaka_maizono/default_p.mdl"
...
TEAM_SAYAKA = Arbitrage.teams.Create(TEAM)