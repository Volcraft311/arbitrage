...
function PANEL:Init()
    ...
    self.main.Paint = function(panel, w, h)
        ...
        draw.DrawText(L("#description_self_button"), "arb.Font_FuturaPTBook_5", W(10), H(3), color_white, TEXT_ALIGN_LEFT)
        draw.DrawText(L("#description_self_text"), "arb.Font_FuturaPTBook_7", W(10), H(28), color_white, TEXT_ALIGN_LEFT)
        draw.DrawText(L("#description_self_desc"), "arb.Font_FuturaPTBook_7", W(10), H(50), Color(150, 150, 150, 255), TEXT_ALIGN_LEFT)
    end
    ...
    self.descriptionEntry:SetPlaceholderText(L("#description_self_placeholder"))
    ...
    submitButton.Paint = function(_, w, h)
        ...
        draw.DrawText(L("#description_self_change"), "arb.Font_FuturaPTBook_8", w / 2, H(0), Color(255, 220, 228, _.alpha), TEXT_ALIGN_CENTER)
