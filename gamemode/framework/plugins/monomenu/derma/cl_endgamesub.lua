...
function PANEL:Init()
    ...
    self.main.Paint = function(panel, w, h)
        ...
        draw.DrawText("Введите название текста сверху", "arb.Font_FuturaPTBook_7", W(10), H(28), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT)
        ...
        draw.DrawText("Выберите нападавшего персонажа", "arb.Font_FuturaPTBook_7", W(10), H(80 + 28), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT)
        draw.DrawText("Монокума", "arb.Font_FuturaPTBook_7", W(10), H(80 + 50), Color(150, 150, 150, 255), TEXT_ALIGN_LEFT)

        draw.DrawText("Выберите убегающего персонажа", "arb.Font_FuturaPTBook_7", W(10), H(80 + 80 + 28), Color(255, 255, 255, 255), TEXT_ALIGN_LEFT)
